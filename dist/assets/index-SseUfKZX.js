var F=Object.defineProperty;var _=(a,e,t)=>e in a?F(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var s=(a,e,t)=>_(a,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const z=`struct SimParams {
  v0: vec4<f32>,
  v1: vec4<f32>,
  v2: vec4<f32>,
  v3: vec4<f32>,
...
`,g=18e3,q=128,x=1.7,B=1,f=(a,e,t)=>Math.min(Math.max(a,e),t),P=(a,e,t)=>a+(e-a)*t,R=[0,38,105,210,340,500];class N{constructor(){s(this,"up",!1);s(this,"down",!1);s(this,"left",!1);s(this,"right",!1);s(this,"boost",!1);const e=(t,n)=>{const i=t.key.toLowerCase(),r=t.code;(i==="w"||i==="arrowup")&&(this.up=n),(i==="s"||i==="arrowdown")&&(this.down=n),(i==="a"||i==="arrowleft")&&(this.left=n),(i==="d"||i==="arrowright")&&(this.right=n),(i==="shift"||r==="ShiftLeft"||r==="ShiftRight")&&(this.boost=n)};window.addEventListener("keydown",t=>e(t,!0)),window.addEventListener("keyup",t=>e(t,!1)),window.addEventListener("blur",()=>{this.up=!1,this.down=!1,this.left=!1,this.right=!1,this.boost=!1})}}class ${constructor(e,t,n){s(this,"canvas");s(this,"hud");s(this,"overlay");s(this,"input",new N);s(this,"device");s(this,"context");s(this,"format");s(this,"particleBuffer");s(this,"simUniformBuffer");s(this,"shipUniformBuffer");s(this,"postUniformBuffer");s(this,"statsBuffer");s(this,"statsReadbackBuffer");s(this,"computePipeline");s(this,"particlePipeline");s(this,"shipPipeline");s(this,"postPipeline");s(this,"computeBindGroup");s(this,"particleBindGroup");s(this,"shipBindGroup");s(this,"postBindGroup");s(this,"sceneTexture");s(this,"sceneView");s(this,"postSampler");s(this,"running",!1);s(this,"gameOver",!1);s(this,"missionCompleted",!1);s(this,"shipPos",{x:.72,y:0});s(this,"shipVel",{x:0,y:.34});s(this,"shipHeading",Math.PI);s(this,"shipRadius",.028);s(this,"thrustVisual",0);s(this,"boostVisual",0);s(this,"fuel",100);s(this,"hull",100);s(this,"score",0);s(this,"elapsed",0);s(this,"levelObjective",0);s(this,"objectiveRateDisplay",0);s(this,"level",1);s(this,"binaryBlend",0);s(this,"radiationIntensity",0);s(this,"asteroidChaos",0);s(this,"collisionPending",!1);s(this,"awaitingLevelChoice",!1);s(this,"recentHitTimer",0);s(this,"bhA",{x:0,y:0,mass:.052});s(this,"bhB",{x:.45,y:0,mass:.04});s(this,"iscoRadius",.3);s(this,"horizonRadius",.11);s(this,"lastTime",0);this.canvas=e,this.hud=t,this.overlay=n,window.addEventListener("resize",()=>this.resize())}async init(){if(!navigator.gpu)throw new Error("WebGPU is not supported in this browser. Use latest Chrome/Edge with WebGPU enabled.");const e=await navigator.gpu.requestAdapter();if(!e)throw new Error("Could not acquire a GPU adapter.");this.device=await e.requestDevice(),this.context=this.canvas.getContext("webgpu"),this.format=navigator.gpu.getPreferredCanvasFormat(),this.context.configure({device:this.device,format:this.format,alphaMode:"opaque"}),this.createResources(),this.createPipelines(),this.resize(),this.reset(),requestAnimationFrame(t=>this.frame(t))}createResources(){const t=new Float32Array(g*8);for(let n=0;n<g;n+=1){const i=n%9===0?1:0,r=Math.random()*Math.PI*2,o=this.iscoRadius+.1+Math.random()*.8,l=Math.cos(r)*o,h=Math.sin(r)*o,d=.35+Math.random()*.95,p=-Math.sin(r)*d,m=Math.cos(r)*d,b=i?.003+Math.random()*.004:.0038+Math.random()*.0062,c=n*8;t[c+0]=l,t[c+1]=h,t[c+2]=p,t[c+3]=m,t[c+4]=b,t[c+5]=i,t[c+6]=Math.random(),t[c+7]=1}this.particleBuffer=this.device.createBuffer({size:t.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.particleBuffer,0,t),this.simUniformBuffer=this.device.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.shipUniformBuffer=this.device.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.postUniformBuffer=this.device.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.statsBuffer=this.device.createBuffer({size:4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.statsReadbackBuffer=this.device.createBuffer({size:4,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.postSampler=this.device.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),this.createSceneTexture()}createSceneTexture(){var e;(e=this.sceneTexture)==null||e.destroy(),this.sceneTexture=this.device.createTexture({size:[this.canvas.width,this.canvas.height],format:this.format,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.sceneView=this.sceneTexture.createView()}createPipelines(){const e=this.device.createShaderModule({code:z}),t=this.device.createShaderModule({code:H}),n=this.device.createShaderModule({code:D}),i=this.device.createShaderModule({code:j});this.computePipeline=this.device.createComputePipeline({layout:"auto",compute:{module:e,entryPoint:"main"}}),this.particlePipeline=this.device.createRenderPipeline({layout:"auto",vertex:{module:t,entryPoint:"vs_main"},fragment:{module:t,entryPoint:"fs_main",targets:[{format:this.format,blend:{color:{srcFactor:"src-alpha",dstFactor:"one",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},primitive:{topology:"triangle-list"}}),this.shipPipeline=this.device.createRenderPipeline({layout:"auto",vertex:{module:n,entryPoint:"vs_main"},fragment:{module:n,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"}}),this.postPipeline=this.device.createRenderPipeline({layout:"auto",vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:[{format:this.format}]},primitive:{topology:"triangle-list"}}),this.computeBindGroup=this.device.createBindGroup({layout:this.computePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.particleBuffer}},{binding:1,resource:{buffer:this.simUniformBuffer}},{binding:2,resource:{buffer:this.statsBuffer}}]}),this.particleBindGroup=this.device.createBindGroup({layout:this.particlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.particleBuffer}},{binding:1,resource:{buffer:this.simUniformBuffer}}]}),this.shipBindGroup=this.device.createBindGroup({layout:this.shipPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.shipUniformBuffer}}]}),this.postBindGroup=this.device.createBindGroup({layout:this.postPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:this.postSampler},{binding:1,resource:this.sceneView},{binding:2,resource:{buffer:this.postUniformBuffer}}]})}resize(){const e=window.devicePixelRatio||1,t=Math.max(1,Math.floor(this.canvas.clientWidth*e)),n=Math.max(1,Math.floor(this.canvas.clientHeight*e));this.canvas.width===t&&this.canvas.height===n||(this.canvas.width=t,this.canvas.height=n,this.device&&(this.createSceneTexture(),this.postBindGroup=this.device.createBindGroup({layout:this.postPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:this.postSampler},{binding:1,resource:this.sceneView},{binding:2,resource:{buffer:this.postUniformBuffer}}]})))}reset(){this.shipPos={x:.72,y:0},this.shipVel={x:0,y:.34},this.shipHeading=Math.PI,this.thrustVisual=0,this.boostVisual=0,this.fuel=100,this.hull=100,this.score=0,this.elapsed=0,this.levelObjective=0,this.objectiveRateDisplay=0,this.level=1,this.binaryBlend=0,this.radiationIntensity=0,this.asteroidChaos=0,this.gameOver=!1,this.missionCompleted=!1,this.awaitingLevelChoice=!1,this.recentHitTimer=0,this.lastTime=0,this.renderStartOverlay()}computeDanger(){const e=Math.hypot(this.shipPos.x-this.bhA.x,this.shipPos.y-this.bhA.y),t=Math.hypot(this.shipPos.x-this.bhB.x,this.shipPos.y-this.bhB.y),n=Math.min(e,this.binaryBlend>.5?t:Number.POSITIVE_INFINITY);return f((this.iscoRadius-n)/(this.iscoRadius-this.horizonRadius),0,1)}updateDifficulty(e){const t=R[this.level];if(this.level===5&&this.levelObjective>=t)return this.completeMission(),!0;const n=this.level<5&&this.levelObjective>=t?this.level+1:this.level;if(n>this.level){const i=this.level;return this.level=n,this.showLevelPassOverlay(i,n),!0}if(this.radiationIntensity=this.level>=3?f((this.level-2)*.45,0,1.25):0,this.asteroidChaos=this.level>=2?f(.35+(this.level-2)*.25,0,1):0,this.level>=4?this.bhA.mass=.052+(this.elapsed-105)*1e-4:this.bhA.mass=P(this.bhA.mass,.052,.05),this.level>=5){this.binaryBlend=f(this.binaryBlend+e*.35,0,1);const i=this.elapsed*.34;this.bhB.x=Math.cos(i)*.42,this.bhB.y=Math.sin(i)*.28}else this.binaryBlend=f(this.binaryBlend-e*.5,0,1),this.bhB.x=.45,this.bhB.y=0;return!1}updateShip(e){this.recentHitTimer=Math.max(0,this.recentHitTimer-e);const t=Number(this.input.right)-Number(this.input.left),n=Number(this.input.up)-Number(this.input.down),i=Math.hypot(t,n),r=this.input.boost&&this.fuel>0&&i>1e-4,o=this.computeDanger();let l=0,h=0;if(i>1e-4&&this.fuel>0){const v=r?1.9:.9;l=t/i*v,h=n/i*v,this.shipHeading=Math.atan2(h,l)-Math.PI/2;const E=(r?14.2:4.9)*(1+o*.95);this.fuel=Math.max(0,this.fuel-E*e)}const d=i>1e-4&&this.fuel>0?r?1:.68:0;this.thrustVisual=P(this.thrustVisual,d,Math.min(1,e*12)),this.boostVisual=P(this.boostVisual,r?1:0,Math.min(1,e*14));const p=this.gravityAt(this.shipPos.x,this.shipPos.y,this.bhA,this.bhA.mass),m=this.gravityAt(this.shipPos.x,this.shipPos.y,this.bhB,this.bhB.mass*this.binaryBlend),c=(this.level>=3?Math.max(0,Math.sin(this.elapsed*1.8+this.level))*this.radiationIntensity:0)*(this.level>=4?1.6:.8),w=1+o*1.4+o*o*1.8,A=.82+o*.28;this.shipVel.x+=(l*A+(p.x+m.x)*w)*e,this.shipVel.y+=(h*A+(p.y+m.y)*w)*e,this.shipVel.x*=1-Math.min(.1*e,.06),this.shipVel.y*=1-Math.min(.1*e,.06),this.shipPos.x+=this.shipVel.x*e,this.shipPos.y+=this.shipVel.y*e,this.fuel=Math.max(0,this.fuel-c*e);const M=Math.hypot(this.shipPos.x-this.bhA.x,this.shipPos.y-this.bhA.y),S=Math.hypot(this.shipPos.x-this.bhB.x,this.shipPos.y-this.bhB.y),L=Math.min(M,this.binaryBlend>.5?S:Number.POSITIVE_INFINITY),u=this.computeDanger();this.score+=e*(1.5+u*30+this.binaryBlend*22);const O=i>1e-4?r?.45:.2:0,y=f((.62-L)/.34,0,1),T=y*y,U=O*(.4+y*1.4+u*1.8),G=this.binaryBlend*(.25+u*.6),k=this.level===1?.24:.12,V=i>1e-4?.16:0,I=u>.18&&u<.9?.42:0,C=k+V+y*.75+T*2.5+u*3.2+U+G+I;if(this.objectiveRateDisplay=P(this.objectiveRateDisplay,C,Math.min(1,e*6)),this.levelObjective+=C*e,u>.26&&u<.88&&!r&&this.fuel<100){const v=(u-.2)*.55;this.fuel=Math.min(100,this.fuel+v*e)}if((M<this.horizonRadius||this.binaryBlend>.45&&S<this.horizonRadius*.95)&&(this.hull=0),this.fuel<=0&&(this.hull-=e*(2+u*14)),(Math.abs(this.shipPos.x)>x*1.1||Math.abs(this.shipPos.y)>B*1.1)&&(this.hull-=e*26),this.recentHitTimer<=0&&this.hull>0){const v=Math.max(.08,.42-u*.24);this.hull=Math.min(100,this.hull+v*e)}}gravityAt(e,t,n,i){const r=n.x-e,o=n.y-t,l=Math.max(r*r+o*o,8e-4),h=1/Math.sqrt(l),d=h*h*h;return{x:r*i*d,y:o*i*d}}uploadUniforms(e){const t=new Float32Array(24);t.set([e,this.elapsed,g,this.level],0),t.set([this.iscoRadius,this.horizonRadius,this.bhA.mass*3.6,this.binaryBlend],4),t.set([this.shipPos.x,this.shipPos.y,this.shipRadius,.18+this.level*.16],8),t.set([this.bhA.x,this.bhA.y,this.bhA.mass*4.4,0],12),t.set([this.bhB.x,this.bhB.y,this.bhB.mass*4.4,0],16),t.set([x,B,this.radiationIntensity,this.asteroidChaos],20),this.device.queue.writeBuffer(this.simUniformBuffer,0,t);const n=new Float32Array(12);n.set([this.shipPos.x,this.shipPos.y,this.shipHeading,this.shipRadius],0),n.set([x,B,this.computeDanger(),this.fuel/100],4),n.set([this.thrustVisual,this.boostVisual,0,0],8),this.device.queue.writeBuffer(this.shipUniformBuffer,0,n);const i=new Float32Array(12);i.set([this.bhA.x,this.bhA.y,this.bhA.mass*3,this.elapsed],0),i.set([this.bhB.x,this.bhB.y,this.bhB.mass*2.7,this.elapsed],4),i.set([x,B,19e-5+this.computeDanger()*35e-5,this.binaryBlend],8),this.device.queue.writeBuffer(this.postUniformBuffer,0,i)}frame(e){if(requestAnimationFrame(h=>this.frame(h)),!this.running||this.gameOver)return;if(this.lastTime===0){this.lastTime=e;return}const t=Math.min(.033,(e-this.lastTime)/1e3);if(this.lastTime=e,this.elapsed+=t,this.updateDifficulty(t)){this.drawHud();return}this.updateShip(t),this.uploadUniforms(t),this.device.queue.writeBuffer(this.statsBuffer,0,new Uint32Array([0]));const i=this.device.createCommandEncoder(),r=i.beginComputePass();r.setPipeline(this.computePipeline),r.setBindGroup(0,this.computeBindGroup),r.dispatchWorkgroups(Math.ceil(g/q)),r.end();const o=i.beginRenderPass({colorAttachments:[{view:this.sceneView,clearValue:{r:.01,g:.01,b:.018,a:1},loadOp:"clear",storeOp:"store"}]});o.setPipeline(this.particlePipeline),o.setBindGroup(0,this.particleBindGroup),o.draw(6,g),o.setPipeline(this.shipPipeline),o.setBindGroup(0,this.shipBindGroup),o.draw(6,1),o.end();const l=i.beginRenderPass({colorAttachments:[{view:this.context.getCurrentTexture().createView(),clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});l.setPipeline(this.postPipeline),l.setBindGroup(0,this.postBindGroup),l.draw(3,1),l.end(),i.copyBufferToBuffer(this.statsBuffer,0,this.statsReadbackBuffer,0,4),this.device.queue.submit([i.finish()]),this.collisionPending||(this.collisionPending=!0,this.statsReadbackBuffer.mapAsync(GPUMapMode.READ).then(()=>{const d=new Uint32Array(this.statsReadbackBuffer.getMappedRange())[0];if(this.statsReadbackBuffer.unmap(),this.collisionPending=!1,d>0){const p=this.computeDanger();this.recentHitTimer=.8;const b=Math.sqrt(Math.min(d,36))*(.002+p*.006),c=.09+p*.14;this.hull=Math.max(0,this.hull-Math.min(c,b))}}).catch(()=>{this.collisionPending=!1})),this.drawHud(),this.hull<=0&&this.endRun()}drawHud(){const e=Math.hypot(this.shipPos.x-this.bhA.x,this.shipPos.y-this.bhA.y),t=Math.hypot(this.shipPos.x-this.bhB.x,this.shipPos.y-this.bhB.y),n=Math.min(e,this.binaryBlend>.5?t:Number.POSITIVE_INFINITY),i=n>this.iscoRadius?"Stable Orbit":n>this.horizonRadius?"ISCO Danger Zone":"EVENT HORIZON",r=R[this.level],o=f(this.levelObjective/r*100,0,100);this.hud.textContent=[`Level: ${this.level} / 5`,`Objective: ${this.levelObjective.toFixed(0)} / ${r} (${o.toFixed(0)}%)`,`Objective Rate: ${this.objectiveRateDisplay.toFixed(2)} /s`,`Boost: ${this.input.boost?"ON":"OFF"}`,`Fuel: ${this.fuel.toFixed(1)}%`,`Hull: ${Math.max(this.hull,0).toFixed(1)}%`,`Score: ${Math.floor(this.score)}`,`Closest Radius: ${n.toFixed(3)} (${i})`,`Binary Influence: ${(this.binaryBlend*100).toFixed(0)}%`,`Time Survived: ${this.elapsed.toFixed(1)}s`].join(`
`),this.hud.style.borderColor=this.computeDanger()>.5?"var(--danger)":"#2e3b5a"}endRun(){this.gameOver=!0,this.running=!1,this.overlay.classList.remove("hidden");const e=this.score>3e3?"Legendary pilot":this.score>1500?"Strong run":"Training run";this.overlay.innerHTML=`
    ...
    `;const e=this.overlay.querySelector("#start-btn");e&&e.addEventListener("click",()=>{this.running=!0,this.overlay.classList.add("hidden")})}showLevelPassOverlay(e,t){if(this.awaitingLevelChoice||e>=5)return;this.awaitingLevelChoice=!0,this.running=!1,this.fuel=Math.min(100,this.fuel+18),this.hull=Math.min(100,this.hull+10),this.levelObjective=0,this.overlay.classList.remove("hidden"),this.overlay.innerHTML=`
      <h1>Level ${e} Cleared</h1>
      <p>You passed Level ${e}. Enter Level ${t}?</p>
      <p>Checkpoint Reward: <strong>+18 Fuel</strong>, <strong>+10 Hull</strong></p>
      <p>Score: <strong>${Math.floor(this.score)}</strong> | Hull: <strong>${Math.max(this.hull,0).toFixed(1)}%</strong> | Fuel: <strong>${this.fuel.toFixed(1)}%</strong></p>
      <div style="display:flex; gap:10px; margin-top: 10px;">
        <button id="continue-btn">Continue</button>
        <button id="exit-btn" style="background: linear-gradient(135deg, #ffd7a1, #ff8b8b);">Exit</button>
      </div>
    `;const n=this.overlay.querySelector("#continue-btn"),i=this.overlay.querySelector("#exit-btn");n&&n.addEventListener("click",()=>{this.awaitingLevelChoice=!1,this.running=!0,this.overlay.classList.add("hidden")}),i&&i.addEventListener("click",()=>{this.awaitingLevelChoice=!1,this.running=!1,this.reset()})}completeMission(){if(this.missionCompleted)return;this.missionCompleted=!0,this.running=!1,this.gameOver=!0,this.overlay.classList.remove("hidden"),this.overlay.innerHTML=`
      <h1>Mission Complete</h1>
      <p>You cleared all 5 levels and escaped the Event Horizon.</p>
      <p>Final score: <strong>${Math.floor(this.score)}</strong> | Time: <strong>${this.elapsed.toFixed(1)}s</strong></p>
      <button id="start-btn">Play Again</button>
    `;const e=this.overlay.querySelector("#start-btn");e&&e.addEventListener("click",()=>{this.reset(),this.running=!0,this.overlay.classList.add("hidden")})}}async function Y(){const a=document.querySelector("#game-canvas"),e=document.querySelector("#hud"),t=document.querySelector("#overlay");if(!a||!e||!t)throw new Error("Required DOM nodes were not found.");const n=new $(a,e,t);try{await n.init()}catch(i){const r=i instanceof Error?i.message:"Unknown initialization error";t.classList.remove("hidden"),t.innerHTML=`
